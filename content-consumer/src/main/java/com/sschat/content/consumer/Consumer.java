...
//        users.add(null);
    ...
    public static void sendRequest(String user) {
        ...
        try {
            ...
            if (response.isOk()) {
                log.info("metrics|{},{},{},{},{}", EnvProperties.PodName, "latency", System.currentTimeMillis(), diff, "value");
                log.info("metrics|{},{},{},{},{}", EnvProperties.PodName, "successQPS", System.currentTimeMillis(), ++succCount, "counter");
            } else {
                log.info("metrics|{},{},{},{},{}", EnvProperties.PodName, "errorQPS", System.currentTimeMillis(), ++errCount, "counter");
            }
